...
const countryData: Record<string, CountryInfo> = {
  bangladesh: {
    ...
    placementData: {
      ...
      internshipOpportunities:
        "Government and private hospitals across Bangladesh",
    },
    studentLife: {
  ...
  georgia: {
    ...
    studentLife: {
      ...
      studentClubs: [
        "International Medical Students Association",
        "Debate Club",
        "Sports Federation",
  ...
  russia: {
    ...
    placementData: {
      ...
      topRecruiters: [
        "Russian Ministry of Health Hospitals",
      ...
      placementRate: "87%",
      internshipOpportunities:
        "Government hospitals and clinical centers across Russia",
    },
    studentLife: {
  ...
  uzbekistan: {
    ...
    placementData: {
      ...
      topRecruiters: [
        "Tashkent International Medical Center",
  ...
  kyrgyzstan: {
    ...
    placementData: {
      ...
      topRecruiters: [
        ...
        "Osh Regional Hospital",
        "International Clinics",
        "Private Hospitals",
      ],
      placementRate: "83%",
      internshipOpportunities:
        "Government and private hospitals in Kyrgyzstan",
    },
    studentLife: {
  ...
  kazakhstan: {
    ...
    placementData: {
      ...
      topRecruiters: [
        ...
        "Astana International Hospital",
        "Almaty Medical Centers",
        "Private Clinics",
      ],
      placementRate: "86%",
...
export default function CountriesClientPage() {
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                <div className="rounded-2xl bg-purple-50 p-4 text-center">
                  ...
                  <div className="text-xl font-bold text-purple-700">
                    {data.studentLife.totalStudents}
                  </div>
                ...
                <div className="rounded-2xl bg-pink-50 p-4 text-center">
                  ...
                  <div className="text-xl font-bold text-pink-700">
                    {data.studentLife.internationalStudents}
                  </div>
                ...
                <div className="rounded-2xl bg-orange-50 p-4 text-center">
                  ...
                  <div className="text-xl font-bold text-orange-700">
                    {data.studentLife.indianStudents}
                  </div>
